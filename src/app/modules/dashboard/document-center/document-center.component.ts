...
export class DocumentCenterComponent {
  ...
  documents = {
    'Educational Certificates': [
      { title: 'Bachelor of Science', fileUrl: '/assets/docs/bsc.pdf', description: 'Completed in 2015' },
      { title: 'High School Certificate', fileUrl: '/assets/docs/hsc.pdf', description: 'Completed in 2010' }
    ],
    'Awards': [
      { title: 'Employee of the Month - Jan 2024', fileUrl: '/assets/docs/award-jan.pdf',description: '' }
    ],
    'Courses Completed Within Organization': [
      { title: 'Angular Training', fileUrl: '/assets/docs/angular-course.pdf', description: 'Completed March 2024' },
